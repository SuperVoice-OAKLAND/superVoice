...
class SincNet(nn.Module):
    ...
    def __init__(self, options):
        ...
        # print("current_input shape is {}".format(current_input))
...
class highCNN(nn.Module):
    def __init__(self, resNet):
        ...
        # we only have one channel, so in_channel is 1.
        self.conv1 = nn.Conv2d(1, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        self.bn1 = resNet.bn1
        self.relu = resNet.relu
        self.maxpool = resNet.maxpool
        self.layer1 = nn.Sequential(*list(resNet.layer1.children()))
        self.layer2 = nn.Sequential(*list(resNet.layer2.children()))
        self.layer3 = nn.Sequential(*list(resNet.layer3.children()))
        self.layer4 = nn.Sequential(*list(resNet.layer4.children()))
