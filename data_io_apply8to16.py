...
# Different from the data_io_joint.py, this file changes the frequency range to real frequency
...
def read_conf():
    ...
    options.en_lst = Config.get('data', 'en_lst')
    options.ve_lst = Config.get('data', 've_lst')
    ...
    # [hdata]
    # Training Pool
    options.htr_lst = Config.get('data', 'tr_lst_high')  # train
    options.hte_lst = Config.get('data', 'te_lst_high')  # test

    # Testing Pool
    options.hen_lst = Config.get('data', 'en_lst_high')  # enroll
    options.hve_lst = Config.get('data', 've_lst_high')  # verify
    ...
    # [highnn]
    options.lower_bound = Config.get('highnn', 'lower_bound')
    options.upper_bound = Config.get('highnn', 'upper_bound')
